...
<figure data-zoomable align="center">
  <img src="/img/docs/gcp-monitoring/clb-logs/view-sink-details.webp" alt="View sink details" />
  <figcaption>
    <i>View Sink details</i>
  </figcaption>
</figure>
...
<figure data-zoomable align="center">
  <img src="/img/docs/gcp-monitoring/clb-logs/writer-identity.webp" alt="Copy Writer Identity" />
  <figcaption>
    <i>Copy Writer Identity</i>
  </figcaption>
</figure>
...
<figure data-zoomable align="center">
  ...
  />
  <figcaption>
    <i>Grant Access to Log Router Sink</i>
  </figcaption>
</figure>
...
<figure data-zoomable align="center">
  ...
  />
  <figcaption>
    <i>Verify log router getting volume upon any trigger of CLB.</i>
  </figcaption>
</figure>
...
_If you want to run otel collector process in the background_:
...
<figure data-zoomable align="center">
  ...
  />
  <figcaption>
    <i>Logs captured by the SigNoz</i>
  </figcaption>
</figure>
...
<figure data-zoomable align="center">
  ...
  />
  <figcaption>
    <i>Detailed overview of the particular log</i>
  </figcaption>
</figure>
That's it! You have successfully set up monitoring for your Cloud Load Balancer logs with SigNoz
Cloud.
